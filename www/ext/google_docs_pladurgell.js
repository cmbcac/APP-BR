function mmg_google_docs_spreadsheet_pladurgell(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Xtrem FM (Linyola):</font></b> '+'<font size="2">' + entry['gsx$xtremfmlinyola'].$t +
									'<br/><b><font size="2">Ràdio Ponent (Mollerusa):</font></b> '+'<font size="2">' + entry['gsx$ràdioponentmollerusa'].$t +
									'<br/><b><font size="2">Ràdio Torregrossa:</font></b> '+'<font size="2">' + entry['gsx$ràdiotorregrossa'].$t +
