function mmg_google_docs_spreadsheet_bergueda(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Ràdio Puig-reig:</font></b> '+'<font size="2">' + entry['gsx$ràdiopuig-reig'].$t +
									'<br/><b><font size="2">Ràdio Berga:</font></b> '+'<font size="2">' + entry['gsx$ràdioberga'].$t +
									...
									'<br/><b><font size="2">Televisió de Berguedà:</font></b> '+'<font size="2">' + entry['gsx$televisiódelberguedà'].$t +
									'<br/><b><font size="2">Canal Taronaja:</font></b> '+'<font size="2">' + entry['gsx$canaltaronja'].$t +
