function mmg_google_docs_spreadsheet_altcamp(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Ràdio Aiguamurcia:</font></b> '+'<font size="2">' + entry['gsx$ràdioaiguamurcia'].$t +
									'<br/><b><font size="2">Alcover Ràdio:</font></b> '+'<font size="2">' + entry['gsx$alcoverràdio'].$t +
									'<br/><b><font size="2">Ràdio El Pla:</font></b> '+'<font size="2">' + entry['gsx$ràdioelpla'].$t +
									'<br/><b><font size="2">Hit 103:</font></b> '+'<font size="2">' + entry['gsx$hit103'].$t +
