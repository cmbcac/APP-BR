function mmg_google_docs_spreadsheet_baixpanades(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Calafell Ràdio:</font></b> '+'<font size="2">' + entry['gsx$calafellràdio'].$t +
									'<br/><b><font size="2">Ràdio Banyeres:</font></b> '+'<font size="2">' + entry['gsx$ràdiobanyeres'].$t +
									'<br/><b><font size="2">Ràdio Bellvei:</font></b> '+'<font size="2">' + entry['gsx$ràdiobellvei'].$t +
									'<br/><b><font size="2">Ràdio El Vendrell:</font></b> '+'<font size="2">' + entry['gsx$ràdioelvendrell'].$t +
									'<br/><b><font size="2">Ràdio Arboç:</font></b> '+'<font size="2">' + entry['gsx$ràdioarboç'].$t +
									'<br/><b><font size="2">Ràdio Cunit:</font></b> '+'<font size="2">' + entry['gsx$ràdiocunit'].$t +
									'<br/><b><font size="2">La Veu de Sant Jaume:</font></b> '+'<font size="2">' + entry['gsx$laveudesantjaume'].$t +
									...
									'<br/><b><font size="2">Panadès Televisió:</font></b> '+'<font size="2">' + entry['gsx$penedèstelevisió'].$t +
									'<br/><b><font size="2">Mola TV:</font></b> '+'<font size="2">' + entry['gsx$molatv'].$t +
									'<br/><b><font size="2">TV El Vendrell / El 3 de 8 TV:</font></b> '+'<font size="2">' + entry['gsx$tvelvendrellel3de8tv'].$t +
