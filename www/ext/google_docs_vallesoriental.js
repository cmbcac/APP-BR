function mmg_google_docs_spreadsheet_vallesoriental(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Punt 7 Ràdio Sant Celoni:</font></b> '+'<font size="2">' + entry['gsx$punt7ràdiosantceloni'].$t +
									'<br/><b><font size="2">Ràdio Granollers:</font></b> '+'<font size="2">' + entry['gsx$ràdiogranollers'].$t +
									'<br/><b><font size="2">Ràdio Caldes:</font></b> '+'<font size="2">' + entry['gsx$ràdiocaldes'].$t +
									'<br/><b><font size="2">Ràdio Castellterçol:</font></b> '+'<font size="2">' + entry['gsx$ràdiocastellterçol'].$t +
									'<br/><b><font size="2">Ràdio La Llagosta:</font></b> '+'<font size="2">' + entry['gsx$ràdiolallagosta'].$t +
									'<br/><b><font size="2">Ràdio L&#39Ametlla:</font></b> '+'<font size="2">' + entry['gsx$ràdiolametlla'].$t +
									'<br/><b><font size="2">Ràdio Llinars:</font></b> '+'<font size="2">' + entry['gsx$ràdiollinars'].$t +
									'<br/><b><font size="2">Selva Mollet del Vallès:</font></b> '+'<font size="2">' + entry['gsx$ràdiomolletdelvallès'].$t +
									'<br/><b><font size="2">Caldes Montornès:</font></b> '+'<font size="2">' + entry['gsx$ràdiomontornès'].$t +
									'<br/><b><font size="2">Ona Codinenca:</font></b> '+'<font size="2">' + entry['gsx$onacodinenca'].$t +
									'<br/><b><font size="2">Ràdio Silenci:</font></b> '+'<font size="2">' + entry['gsx$ràdiosilenci'].$t +
									'<br/><b><font size="2">RV-94.2:</font></b> '+'<font size="2">' + entry['gsx$rv-94.2'].$t +
									'<br/><b><font size="2">Ràdio Vitamènia:</font></b> '+'<font size="2">' + entry['gsx$ràdiovitamènia'].$t +
									'<br/><b><font size="2">RAP 107 FM:</font></b> '+'<font size="2">' + entry['gsx$rap107fm'].$t +
									'<br/><b><font size="2">Ràdio Vilamajor:</font></b> '+'<font size="2">' + entry['gsx$ràdiovilamajor'].$t +
									...
									'<br/><b><font size="2">Vallès Oriental TV:</font></b> '+'<font size="2">' + entry['gsx$vallèsorientaltv'].$t +
									'<br/><b><font size="2">Vallès Visió:</font></b> '+'<font size="2">' + entry['gsx$vallèsvisió'].$t +
