function mmg_google_docs_spreadsheet_maresme(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Caldetes Ràdio:</font></b> '+'<font size="2">' + entry['gsx$caldetesràdio'].$t +
									'<br/><b><font size="2">Premià de Dalt Ràdio:</font></b> '+'<font size="2">' + entry['gsx$premiàdedaltràdio'].$t +
									'<br/><b><font size="2">Ràdio Arenys:</font></b> '+'<font size="2">' + entry['gsx$ràdioarenys'].$t +
									'<br/><b><font size="2">Ràdio Arenys de Munt:</font></b> '+'<font size="2">' + entry['gsx$ràdioarenysdemunt'].$t +
									'<br/><b><font size="2">Ràdio Argentona:</font></b> '+'<font size="2">' + entry['gsx$ràdioargentona'].$t +
									'<br/><b><font size="2">Ràdio Cabrera:</font></b> '+'<font size="2">' + entry['gsx$ràdiocabrera'].$t +
									'<br/><b><font size="2">Ràdio Calella:</font></b> '+'<font size="2">' + entry['gsx$ràdiocalella'].$t +
									'<br/><b><font size="2">Ràdio Canet:</font></b> '+'<font size="2">' + entry['gsx$ràdiocanet'].$t +
									'<br/><b><font size="2">Ràdio Masnou:</font></b> '+'<font size="2">' + entry['gsx$ràdiomasnou'].$t +
									'<br/><b><font size="2">Ràdio Litoral:</font></b> '+'<font size="2">' + entry['gsx$ràdiolitoral'].$t +
									'<br/><b><font size="2">Ràdio Llavaneres:</font></b> '+'<font size="2">' + entry['gsx$ràdiollavaneres'].$t +
									'<br/><b><font size="2">Ona Malgrat:</font></b> '+'<font size="2">' + entry['gsx$onamalgrat'].$t +
									'<br/><b><font size="2">Ràdio Pineda:</font></b> '+'<font size="2">' + entry['gsx$ràdiopineda'].$t +
									'<br/><b><font size="2">Ràdio Prèmia de Mar:</font></b> '+'<font size="2">' + entry['gsx$ràdiopremiàdemar'].$t +
									'<br/><b><font size="2">Ràdio Sant Cebrià:</font></b> '+'<font size="2">' + entry['gsx$ràdiosantcebrià'].$t +
									'<br/><b><font size="2">Ràdio Jove:</font></b> '+'<font size="2">' + entry['gsx$ràdiojove'].$t +
									'<br/><b><font size="2">Ràdio Tiana:</font></b> '+'<font size="2">' + entry['gsx$ràdiotiana'].$t +
									'<br/><b><font size="2">Vilassar de Dalt Ràdio:</font></b> '+'<font size="2">' + entry['gsx$vilassardedaltràdio'].$t +
									'<br/><b><font size="2">Vilassar Ràdio:</font></b> '+'<font size="2">' + entry['gsx$vilassarràdio'].$t +
									'<br/><b><font size="2">Ràdio Santvi:</font></b> '+'<font size="2">' + entry['gsx$ràdiosantvi'].$t +
									'<br/><b><font size="2">Mataró Ràdio:</font></b> '+'<font size="2">' + entry['gsx$mataróràdio'].$t +
									'<br/><b><font size="2">Ràdio Palafolls:</font></b> '+'<font size="2">' + entry['gsx$ràdiopalafolls'].$t +
									'<br/><b><font size="2">Ràdio Vallalta:</font></b> '+'<font size="2">' + entry['gsx$ràdiovallalta'].$t +
									'<br/><b><font size="2">Ràdio Marina:</font></b> '+'<font size="2">' + entry['gsx$ràdiomarina'].$t +
									...
									'<br/><b><font size="2">M1 TV:</font></b> '+'<font size="2">' + entry['gsx$m1tv'].$t +
									'<br/><b><font size="2">Maresme TV:</font></b> '+'<font size="2">' + entry['gsx$maresmetv'].$t +
