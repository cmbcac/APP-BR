function mmg_google_docs_spreadsheet_terraalta(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Ràdio Gandesa:</font></b> '+'<font size="2">' + entry['gsx$ràdiogandesa'].$t +
									'<br/><b><font size="2">Ràdio Batea:</font></b> '+'<font size="2">' + entry['gsx$ràdiobatea'].$t +
									'<br/><b><font size="2">Ràdio Fatarella:</font></b> '+'<font size="2">' + entry['gsx$ràdiofatarella'].$t +
