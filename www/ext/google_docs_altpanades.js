function mmg_google_docs_spreadsheet_altpanades(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Canal 20 Ràdio Olèrdola:</font></b> '+'<font size="2">' + entry['gsx$canal20ràdioolèrdola'].$t +
									'<br/><b><font size="2">Ràdio Foix:</font></b> '+'<font size="2">' + entry['gsx$ràdiofoix'].$t +
									'<br/><b><font size="2">Ràdio Gelida:</font></b> '+'<font size="2">' + entry['gsx$ràdiogelida'].$t +
									'<br/><b><font size="2">Ràdio Mediona:</font></b> '+'<font size="2">' + entry['gsx$ràdiomediona'].$t +
									'<br/><b><font size="2">Ràdio Sant Sadurní:</font></b> '+'<font size="2">' + entry['gsx$ràdiosantsadurní'].$t +
									'<br/><b><font size="2">Ràdio Vilafranca:</font></b> '+'<font size="2">' + entry['gsx$ràdiovilafranca'].$t +
									'<br/><b><font size="2">Sarroca Ràdio:</font></b> '+'<font size="2">' + entry['gsx$sarrocaràdio'].$t +
									'<br/><b><font size="2">Ona Bitlles:</font></b> '+'<font size="2">' + entry['gsx$onabitlles'].$t +										
									'<br/><b><font size="2">Vilobí del Penedès Ràdio:</font></b> '+'<font size="2">' + entry['gsx$vilobídelpenedèsràdio'].$t +	
									'<br/><b><font size="2">Penedès FM Subirats:</font></b> '+'<font size="2">' + entry['gsx$penedèsfmsubirats'].$t +
									'<br/><b><font size="2">SER Penedès - Garraf (Vilafranca del Penedès):</font></b> '+'<font size="2">' + entry['gsx$serpenedès-garrafvilafrancadelpenedès'].$t +										
									'<br/><b><font size="2">Ràdio Estel (Sant Sadurní d&#39;Anoia:</font></b> '+'<font size="2">' + entry['gsx$ràdioestelsantsadurnídanoia'].$t +	
									...
									'<br/><b><font size="2">Canal Blau:</font></b> '+'<font size="2">' + entry['gsx$canalblau'].$t +
									'<br/><b><font size="2">Penedès TV:</font></b> '+'<font size="2">' + entry['gsx$penedèstv'].$t +
									'<br/><b><font size="2">TV El Vendrell / 3 de 8 TV:</font></b> '+'<font size="2">' + entry['gsx$tvelvendrell3de8tv'].$t +
