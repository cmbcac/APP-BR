function mmg_google_docs_spreadsheet_altemporda(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Ràdio Cap de Creus (Cadaquès):</font></b> '+'<font size="2">' + entry['gsx$ràdiocapdecreuscadaqués'].$t +
									'<br/><b><font size="2">Xtra FM (Castellò d&#39;Empúries:</font></b> '+'<font size="2">' + entry['gsx$xtrafmcastellòdempuries'].$t +
									'<br/><b><font size="2">Ràdio l&#39;Escala:</font></b> '+'<font size="2">' + entry['gsx$ràdiolescala'].$t +
									'<br/><b><font size="2">Ràdio Vilafant:</font></b> '+'<font size="2">' + entry['gsx$ràdiovilafant'].$t +
									'<br/><b><font size="2">Cent 7 Música - Ràdio Vila-sacra:</font></b> '+'<font size="2">' + entry['gsx$cent7música-ràdiovila-sacra'].$t +
									'<br/><b><font size="2">Ona Vilamalla:</font></b> '+'<font size="2">' + entry['gsx$onavilamalla'].$t +
									'<br/><b><font size="2">Ràdio Roses:</font></b> '+'<font size="2">' + entry['gsx$ràdioroses'].$t +
									'<br/><b><font size="2">Ràdio Saus:</font></b> '+'<font size="2">' + entry['gsx$ràdiosaus'].$t +
									'<br/><b><font size="2">Ràdio Cabanes:</font></b> '+'<font size="2">' + entry['gsx$ràdiocabanes'].$t +
									'<br/><b><font size="2">Ràdio Mar d&#39Amunt (El Port de la Selva):</font></b> '+'<font size="2">' + entry['gsx$ràdiomardamuntelportdelaselva'].$t +
									...
									'<br/><b><font size="2">Canal 10 Empordà:</font></b> '+'<font size="2">' + entry['gsx$canal10empordà'].$t +
									'<br/><b><font size="2">Empordà Televisió:</font></b> '+'<font size="2">' + entry['gsx$empordàtelevisió'].$t +
