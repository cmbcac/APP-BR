function mmg_google_docs_spreadsheet_riberadebre(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Ràdio Flix:</font></b> '+'<font size="2">' + entry['gsx$ràdioflix'].$t +
									'<br/><b><font size="2">Ràdio Móra d&#39Ebre:</font></b> '+'<font size="2">' + entry['gsx$ràdiomóradebre'].$t +
									'<br/><b><font size="2">Ràdio Móra de la Nova:</font></b> '+'<font size="2">' + entry['gsx$ràdiomóralanova'].$t +
									'<br/><b><font size="2">Ràdio Tivissa:</font></b> '+'<font size="2">' + entry['gsx$radiotivissa'].$t +
