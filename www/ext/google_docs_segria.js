function mmg_google_docs_spreadsheet_segria(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Alpicat Ràdio:</font></b> '+'<font size="2">' + entry['gsx$alpicatràdio'].$t +
									'<br/><b><font size="2">EMUN FM Ràdio Alfarràs:</font></b> '+'<font size="2">' + entry['gsx$emunfmràdioalfarràs'].$t +
									'<br/><b><font size="2">Lleida Ràdio:</font></b> '+'<font size="2">' + entry['gsx$lleidaràdio'].$t +
									'<br/><b><font size="2">EMUN FM Ràdio Almenar:</font></b> '+'<font size="2">' + entry['gsx$emunfmràdioalmenar'].$t +
									'<br/><b><font size="2">Ràdio Corbins:</font></b> '+'<font size="2">' + entry['gsx$ràdiocorbins'].$t +
									'<br/><b><font size="2">EMUN FM Ràdio Alguaire:</font></b> '+'<font size="2">' + entry['gsx$emunfmràdioalguaire'].$t +
									'<br/><b><font size="2">Ràdio Rosselló:</font></b> '+'<font size="2">' + entry['gsx$ràdiorosselló'].$t +
									'<br/><b><font size="2">Ràdio Puigverd:</font></b> '+'<font size="2">' + entry['gsx$ràdiopuigverd'].$t +
									'<br/><b><font size="2">Ràdio Almecelles:</font></b> '+'<font size="2">' + entry['gsx$ràdioalmacelles'].$t +
									'<br/><b><font size="2">Ràdio Alcoletge:</font></b> '+'<font size="2">' + entry['gsx$ràdioalcoletge'].$t +
									'<br/><b><font size="2">EMUN FM Ràdio Torrefarrera:</font></b> '+'<font size="2">' + entry['gsx$emunfmràdiotorrefarrera'].$t +
									'<br/><b><font size="2">Ràdio U-A-1:</font></b> '+'<font size="2">' + entry['gsx$ràdiou-a-1'].$t +
									...
									'<br/><b><font size="2">Lleida TV:</font></b> '+'<font size="2">' + entry['gsx$lleidatv'].$t +
