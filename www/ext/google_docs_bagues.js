function mmg_google_docs_spreadsheet_bagues(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Radio Marca:</font></b> '+'<font size="2">' + entry['gsx$radioblanca'].$t +
									'<br/><br/><u><b><font size="4">RÀDIO LOCAL</font></u></b></b>'+
									'<br/><b><font size="2">Ràdio Cardona:</font></b> '+'<font size="2">' + entry['gsx$ràdiocardona'].$t +
									'<br/><b><font size="2">La Veu de Navàs:</font></b> '+'<font size="2">' + entry['gsx$laveudenavàs'].$t +
									'<br/><b><font size="2">Ràdio 010 (Santa Maria d&#39Olò:</font></b> '+'<font size="2">' + entry['gsx$ràdio010santamariadolò'].$t +
									'<br/><b><font size="2">Ràdio Avinyó:</font></b> '+'<font size="2">' + entry['gsx$ràdioavinyó'].$t +
									'<br/><b><font size="2">Ràdio Sant Salvador:</font></b> '+'<font size="2">' + entry['gsx$ràdiosantsalvador'].$t +
									'<br/><b><font size="2">Ràdio Moià:</font></b> '+'<font size="2">' + entry['gsx$ràdiomoià'].$t +
									'<br/><b><font size="2">Ràdio Artés:</font></b> '+'<font size="2">' + entry['gsx$ràdioartés'].$t +
									'<br/><b><font size="2">Ràdio Balsareny:</font></b> '+'<font size="2">' + entry['gsx$ràdiobalsareny'].$t +
									'<br/><b><font size="2">Ràdio Sallent:</font></b> '+'<font size="2">' + entry['gsx$ràdiosallent'].$t +
									'<br/><b><font size="2">Ràdio Santpedor:</font></b> '+'<font size="2">' + entry['gsx$ràdiosantpedor'].$t +
									'<br/><b><font size="2">Ràdio Sant Fruitós:</font></b> '+'<font size="2">' + entry['gsx$ràdiosantfruitós'].$t +
									'<br/><b><font size="2">Ràdio Sant Joan:</font></b> '+'<font size="2">' + entry['gsx$ràdiosantjoan'].$t +
									'<br/><b><font size="2">Ràdio Súria:</font></b> '+'<font size="2">' + entry['gsx$ràdiosúria'].$t +
									'<br/><b><font size="2">Ràdio Vilomara:</font></b> '+'<font size="2">' + entry['gsx$ràdiovilomara'].$t +
									'<br/><b><font size="2">Ràdio Zenit (Sant Vicenç de Castellet):</font></b> '+'<font size="2">' + entry['gsx$ràdiozenitsantvicençdecastellet'].$t +
									'<br/><b><font size="2">Styl Fm:</font></b> '+'<font size="2">' + entry['gsx$stylfm'].$t +
									'<br/><b><font size="2">Altres emisores de ràdio 1:</font></b> '+'<font size="2">' + entry['gsx$altresemissoresderàdio1'].$t +
									'<br/><b><font size="2">Altres emisores de ràdio 2:</font></b> '+'<font size="2">' + entry['gsx$altresemissoresderàdio2'].$t +
									'<br/><b><font size="2">Altres emisores de ràdio 3:</font></b> '+'<font size="2">' + entry['gsx$altresemissoresderàdio3'].$t +			
									...
									'<br/><b><font size="2">Televisió del Berguedà:</font></b> '+'<font size="2">' + entry['gsx$barçatv'].$t +
									'<br/><b><font size="2">Canal Taronja:</font></b> '+'<font size="2">' + entry['gsx$televisiódelberguedà'].$t +
