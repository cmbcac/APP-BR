function mmg_google_docs_spreadsheet_girones(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">FeM Girona:</font></b> '+'<font size="2">' + entry['gsx$femgirona'].$t +
									'<br/><b><font size="2">Ràdio Cassà:</font></b> '+'<font size="2">' + entry['gsx$ràdiocassà'].$t +
									'<br/><b><font size="2">Ràdio Celrà:</font></b> '+'<font size="2">' + entry['gsx$ràdiocelrà'].$t +
									'<br/><b><font size="2">Llagostera Ràdio:</font></b> '+'<font size="2">' + entry['gsx$llagosteraràdio'].$t +
									'<br/><b><font size="2">Ràdio Quart:</font></b> '+'<font size="2">' + entry['gsx$ràdioquart'].$t +
									'<br/><b><font size="2">Ràdio Salt:</font></b> '+'<font size="2">' + entry['gsx$ràdiosalt'].$t +
									'<br/><b><font size="2">Ràdio Sant Gregori:</font></b> '+'<font size="2">' + entry['gsx$ràdiosantgregori'].$t +
									'<br/><b><font size="2">Ràdio Sarrià:</font></b> '+'<font size="2">' + entry['gsx$ràdiosarrià'].$t +
									'<br/><b><font size="2">Ràdio Fornells de la Selva-Desmunt:</font></b> '+'<font size="2">' + entry['gsx$ràdiofornellsdelaselva-desmunt'].$t +
									'<br/><b><font size="2">Ràdio Vilablareix:</font></b> '+'<font size="2">' + entry['gsx$ràdiovilablareix'].$t +									
									...
									'<br/><b><font size="2">Televisió de Girona:</font></b> '+'<font size="2">' + entry['gsx$televisiódegirona'].$t +
									'<br/><b><font size="2">Banyoles Televisió:</font></b> '+'<font size="2">' + entry['gsx$banyolestelevisió'].$t +
