function mmg_google_docs_spreadsheet_pladestany(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Ràdio Banyoles:</font></b> '+'<font size="2">' + entry['gsx$ràdiobanyoles'].$t +
									...
									'<br/><b><font size="2">Banyoles TV:</font></b> '+'<font size="2">' + entry['gsx$banyolestv'].$t +
									'<br/><b><font size="2">TV de Girona:</font></b> '+'<font size="2">' + entry['gsx$tvdegirona'].$t +
