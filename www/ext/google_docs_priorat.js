function mmg_google_docs_spreadsheet_priorat(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Ràdio Falset:</font></b> '+'<font size="2">' + entry['gsx$ràdiofalset'].$t +
									'<br/><b><font size="2">Ràdio Vilella Alta:</font></b> '+'<font size="2">' + entry['gsx$ràdiovilellaalta'].$t +
