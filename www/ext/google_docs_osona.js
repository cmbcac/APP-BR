function mmg_google_docs_spreadsheet_osona(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Ràdio Manlleu:</font></b> '+'<font size="2">' + entry['gsx$ràdiomanlleu'].$t +
									'<br/><b><font size="2">Ràdio Montesquiu:</font></b> '+'<font size="2">' + entry['gsx$ràdiomontesquiu'].$t +
									'<br/><b><font size="2">Ràdio Ona:</font></b> '+'<font size="2">' + entry['gsx$ràdioona'].$t +
									'<br/><b><font size="2">Ràdio Pista:</font></b> '+'<font size="2">' + entry['gsx$ràdiopista'].$t +
									'<br/><b><font size="2">Ràdio Roda:</font></b> '+'<font size="2">' + entry['gsx$ràdioroda'].$t +
									'<br/><b><font size="2">Ràdio Taradell:</font></b> '+'<font size="2">' + entry['gsx$ràdiotaradell'].$t +
									'<br/><b><font size="2">Ràdio Voltregà:</font></b> '+'<font size="2">' + entry['gsx$ràdiovoltregà'].$t +
									'<br/><b><font size="2">El 9 FM:</font></b> '+'<font size="2">' + entry['gsx$el9fm'].$t +
									'<br/><b><font size="2">Ràdio Vic:</font></b> '+'<font size="2">' + entry['gsx$ràdiovic'].$t +
									...
									'<br/><b><font size="2">Canal Taronja:</font></b> '+'<font size="2">' + entry['gsx$canaltaronja'].$t +
									'<br/><b><font size="2">El Punt Avui TV:</font></b> '+'<font size="2">' + entry['gsx$elpuntavuitv'].$t +
									'<br/><b><font size="2">El 9 TV:</font></b> '+'<font size="2">' + entry['gsx$el9tv'].$t +
