function mmg_google_docs_spreadsheet_baixllobregat(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">El Prat Ràdio:</font></b> '+'<font size="2">' + entry['gsx$elpratràdio'].$t +
									'<br/><b><font size="2">Papiol FM:</font></b> '+'<font size="2">' + entry['gsx$papiolfm'].$t +
									'<br/><b><font size="2">Olesa Ràdio:</font></b> '+'<font size="2">' + entry['gsx$olesaràdio'].$t +
									'<br/><b><font size="2">Ràdio Abrera:</font></b> '+'<font size="2">' + entry['gsx$ràdioabrera'].$t +
									'<br/><b><font size="2">Ràdio Castelldefels:</font></b> '+'<font size="2">' + entry['gsx$ràdiocastelldefels'].$t +
									'<br/><b><font size="2">Ràdio Cervelló:</font></b> '+'<font size="2">' + entry['gsx$ràdiocervelló'].$t +
									'<br/><b><font size="2">Ràdio Collbató:</font></b> '+'<font size="2">' + entry['gsx$ràdiocollbató'].$t +
									'<br/><b><font size="2">Ràdio Corbera:</font></b> '+'<font size="2">' + entry['gsx$ràdiocorbera'].$t +
									'<br/><b><font size="2">Ràdio Cornellà:</font></b> '+'<font size="2">' + entry['gsx$ràdiocornellà'].$t +
									'<br/><b><font size="2">Ràdio Desvem:</font></b> '+'<font size="2">' + entry['gsx$ràdiodesvern'].$t +
									'<br/><b><font size="2">Ràdio Esparreguera:</font></b> '+'<font size="2">' + entry['gsx$ràdioesparreguera'].$t +
									'<br/><b><font size="2">Ràdio Estudi (Esplugues de Llobregat):</font></b> '+'<font size="2">' + entry['gsx$ràdioestudiespluguesdellobregat'].$t +
									'<br/><b><font size="2">Ràdio Martorell:</font></b> '+'<font size="2">' + entry['gsx$ràdiomartorell'].$t +
									'<br/><b><font size="2">Ràdio Molins de Rei:</font></b> '+'<font size="2">' + entry['gsx$ràdiomolinsderei'].$t +
									'<br/><b><font size="2">Ràdio Sant Andreu:</font></b> '+'<font size="2">' + entry['gsx$ràdiosantandreu'].$t +
									'<br/><b><font size="2">Ràdio Sant Boi:</font></b> '+'<font size="2">' + entry['gsx$ràdiosantboi'].$t +
									...
									'<br/><b><font size="2">TAC 12:</font></b> '+'<font size="2">' + entry['gsx$tac12'].$t +
