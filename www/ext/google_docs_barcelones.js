function mmg_google_docs_spreadsheet_barcelones(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Barcelona FM:</font></b> '+'<font size="2">' + entry['gsx$barcelonafm'].$t +
									'<br/><b><font size="2">Grama Ràdio:</font></b> '+'<font size="2">' + entry['gsx$gramaràdio'].$t +
									'<br/><b><font size="2">Ràdiob - Ràdio Ciutat de Badalona:</font></b> '+'<font size="2">' + entry['gsx$ràdiob-ràdiociutatdebadalona'].$t +
									'<br/><b><font size="2">Ràdio l&#39;Hospitalet:</font></b> '+'<font size="2">' + entry['gsx$ràdiolhospitalet'].$t +
									'<br/><b><font size="2">Sant Adrià  Ràdio:</font></b> '+'<font size="2">' + entry['gsx$santadriàràdio'].$t +
									...
									'<br/><b><font size="2">Barcelona Televisió (BTV):</font></b> '+'<font size="2">' + entry['gsx$barcelonatelevisióbtv'].$t +
									'<br/><b><font size="2">TV l&#39;Hospitalet:</font></b> '+'<font size="2">' + entry['gsx$tvlhospitalet'].$t +
									'<br/><b><font size="2">Televisió de Badalona (Teleb):</font></b> '+'<font size="2">' + entry['gsx$televisiódebadalonateleb'].$t +
									'<br/><b><font size="2">25 TV:</font></b> '+'<font size="2">' + entry['gsx$tv_2'].$t +
