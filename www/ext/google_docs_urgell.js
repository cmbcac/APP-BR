function mmg_google_docs_spreadsheet_urgell(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Ràdio Bellpuig:</font></b> '+'<font size="2">' + entry['gsx$ràdiobellpuig'].$t +
									'<br/><b><font size="2">Ràdio Sió:</font></b> '+'<font size="2">' + entry['gsx$ràdiosió'].$t +
									'<br/><b><font size="2">Ràdio Tàrrega:</font></b> '+'<font size="2">' + entry['gsx$ràdiotàrrega'].$t +										
