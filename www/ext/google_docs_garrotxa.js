function mmg_google_docs_spreadsheet_garrotxa(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Bas Ràdio:</font></b> '+'<font size="2">' + entry['gsx$basràdio'].$t +
									'<br/><b><font size="2">Ràdio Besalú:</font></b> '+'<font size="2">' + entry['gsx$ràdiobesalú'].$t +
									'<br/><b><font size="2">Ràdio La Vall:</font></b> '+'<font size="2">' + entry['gsx$ràdiolavall'].$t +
									'<br/><b><font size="2">Ràdio Les Planes:</font></b> '+'<font size="2">' + entry['gsx$ràdiolesplanes'].$t +
									'<br/><b><font size="2">Ràdio Sant Joan:</font></b> '+'<font size="2">' + entry['gsx$ràdiosantjoan'].$t +
									'<br/><b><font size="2">Ràdio Olot:</font></b> '+'<font size="2">' + entry['gsx$ràdioolot'].$t +
									...
									'<br/><b><font size="2">Televisió del Ripollès:</font></b> '+'<font size="2">' + entry['gsx$televisiódelripollès'].$t +
									'<br/><b><font size="2">Olot Televisió:</font></b> '+'<font size="2">' + entry['gsx$olottelevisió'].$t +
