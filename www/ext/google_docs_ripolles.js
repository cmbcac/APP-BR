function mmg_google_docs_spreadsheet_ripolles(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">La Veu de Sant Joan:</font></b> '+'<font size="2">' + entry['gsx$laveudesantjoan'].$t +
									'<br/><b><font size="2">Live FM:</font></b> '+'<font size="2">' + entry['gsx$livefm'].$t +
									'<br/><b><font size="2">Ràdio Campodron:</font></b> '+'<font size="2">' + entry['gsx$ràdiocamprodon'].$t +
									'<br/><b><font size="2">Ràdio Ripoll:</font></b> '+'<font size="2">' + entry['gsx$ràdioripoll'].$t +
									...
									'<br/><b><font size="2">Olot TV:</font></b> '+'<font size="2">' + entry['gsx$olottv'].$t +
