function mmg_google_docs_spreadsheet_lanoguera(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">EMUN FM Ràdio Albesa:</font></b> '+'<font size="2">' + entry['gsx$emunfmràdioalbesa'].$t +
									'<br/><b><font size="2">Ràdio Artesa:</font></b> '+'<font size="2">' + entry['gsx$emunfmràdioalbesa'].$t +
									'<br/><b><font size="2">Ràdio Balaguer:</font></b> '+'<font size="2">' + entry['gsx$ràdiobalaguer'].$t +
									'<br/><b><font size="2">Ràdio Menàrguens:</font></b> '+'<font size="2">' + entry['gsx$ràdiomenàrguens'].$t +
									'<br/><b><font size="2">Vallfogona Ràdio:</font></b> '+'<font size="2">' + entry['gsx$vallfogonaràdio'].$t +
									'<br/><b><font size="2">Ràdio Foradada:</font></b> '+'<font size="2">' + entry['gsx$ràdioforadada'].$t +
									'<br/><b><font size="2">Ràdio Ponts:</font></b> '+'<font size="2">' + entry['gsx$ràdioponts'].$t +
