function mmg_google_docs_spreadsheet_cerdanya(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Ràdio Puigcerdà:</font></b> '+'<font size="2">' + entry['gsx$ràdiopuigcerdà'].$t +
									'<br/><b><font size="2">Ràdio Bellver:</font></b> '+'<font size="2">' + entry['gsx$ràdiobellver'].$t +
									'<br/><b><font size="2">Ràdio Alp:</font></b> '+'<font size="2">' + entry['gsx$ràdioalp'].$t +
									'<br/><b><font size="2">Pròxima FM:</font></b> '+'<font size="2">' + entry['gsx$pròximafm'].$t +
									'<br/><b><font size="2">Digital Hits FM:</font></b> '+'<font size="2">' + entry['gsx$digitalhitsfm'].$t +
									'<br/><b><font size="2">Gum FM:</font></b> '+'<font size="2">' + entry['gsx$gumfm'].$t +
									...
									'<br/><b><font size="2">Pirineus TV:</font></b> '+'<font size="2">' + entry['gsx$pirineustv'].$t +
									'<br/><b><font size="2">Andorra TV:</font></b> '+'<font size="2">' + entry['gsx$andorratv'].$t +
