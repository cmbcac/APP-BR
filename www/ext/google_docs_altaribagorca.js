function mmg_google_docs_spreadsheet_altaribagorca(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Ràdio Suert:</font></b> '+'<font size="2">' + entry['gsx$ràdiosuert'].$t +
									'<br/><b><font size="2">GUM FM:</font></b> '+'<font size="2">' + entry['gsx$gumfm'].$t +
									'<br/><b><font size="2">Ràdio Adventista:</font></b> '+'<font size="2">' + entry['gsx$ràdioadventista'].$t +									
