function mmg_google_docs_spreadsheet_anoia(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Montbui Ràdio:</font></b> '+'<font size="2">' + entry['gsx$montbuiràdio'].$t +
									'<br/><b><font size="2">Ràdio Altiplà:</font></b> '+'<font size="2">' + entry['gsx$ràdioaltiplà'].$t +
									'<br/><b><font size="2">Bruc Ràdio:</font></b> '+'<font size="2">' + entry['gsx$brucràdio'].$t +
									'<br/><b><font size="2">Ràdio Capellades:</font></b> '+'<font size="2">' + entry['gsx$ràdiocapellades'].$t +
									'<br/><b><font size="2">Ràdio Igualada:</font></b> '+'<font size="2">' + entry['gsx$ràdioigualada'].$t +
									'<br/><b><font size="2">Ràdio Masquefa:</font></b> '+'<font size="2">' + entry['gsx$ràdiomasquefa'].$t +
									'<br/><b><font size="2">Ràdio Nova:</font></b> '+'<font size="2">' + entry['gsx$ràdionova'].$t +
									'<br/><b><font size="2">Ràdio Piera:</font></b> '+'<font size="2">' + entry['gsx$ràdiopiera'].$t +										
									'<br/><b><font size="2">Ràdio Hosalets:</font></b> '+'<font size="2">' + entry['gsx$ràdiohostalets'].$t +	
									...
									'<br/><b><font size="2">Canal Taronja Anoia:</font></b> '+'<font size="2">' + entry['gsx$canaltaronjaanoia'].$t +
