function mmg_google_docs_spreadsheet_solsones(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Ràdio Pinós:</font></b> '+'<font size="2">' + entry['gsx$ràdiopinós'].$t +
									'<br/><b><font size="2">Solsona FM:</font></b> '+'<font size="2">' + entry['gsx$solsonafm'].$t +
