function mmg_google_docs_spreadsheet_garraf(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Canal Blau FM:</font></b> '+'<font size="2">' + entry['gsx$canalblaufm'].$t +
									'<br/><b><font size="2">Ràdio Cubelles:</font></b> '+'<font size="2">' + entry['gsx$ràdiocubelles'].$t +
									'<br/><b><font size="2">Ràdio Maricel:</font></b> '+'<font size="2">' + entry['gsx$ràdiomaricel'].$t +
									'<br/><b><font size="2">Ràdio Ribes:</font></b> '+'<font size="2">' + entry['gsx$ràdioribes'].$t +
