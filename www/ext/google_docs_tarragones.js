function mmg_google_docs_spreadsheet_tarragones(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Altafulla Ràdio:</font></b> '+'<font size="2">' + entry['gsx$altafullaràdio'].$t +
									'<br/><b><font size="2">Constantí Ràdio:</font></b> '+'<font size="2">' + entry['gsx$constantíràdio'].$t +
									'<br/><b><font size="2">Ràdio el Morell:</font></b> '+'<font size="2">' + entry['gsx$ràdioelmorell'].$t +
									'<br/><b><font size="2">Ràdio Pobla de Mafumet:</font></b> '+'<font size="2">' + entry['gsx$ràdiopoblademafumet'].$t +
									'<br/><b><font size="2">Ona La Torre:</font></b> '+'<font size="2">' + entry['gsx$onalatorre'].$t +
									'<br/><b><font size="2">Tarragona Ràdio:</font></b> '+'<font size="2">' + entry['gsx$tarragonaràdio'].$t +
									'<br/><b><font size="2">Roda de Berà Ràdio:</font></b> '+'<font size="2">' + entry['gsx$rodadeberàràdio'].$t +
