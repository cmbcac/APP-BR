function mmg_google_docs_spreadsheet_selva(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Nova Ràdio Lloret:</font></b> '+'<font size="2">' + entry['gsx$novaràdiolloret'].$t +
									'<br/><b><font size="2">Ràdio Arbúcies:</font></b> '+'<font size="2">' + entry['gsx$ràdioarbúcies'].$t +
									'<br/><b><font size="2">Ràdio Blanes:</font></b> '+'<font size="2">' + entry['gsx$ràdioblanes'].$t +
									'<br/><b><font size="2">Ràdio DOS 84:</font></b> '+'<font size="2">' + entry['gsx$ràdiodos84'].$t +
									'<br/><b><font size="2">Ràdio Sant Hilari:</font></b> '+'<font size="2">' + entry['gsx$ràdiosanthilari'].$t +
									'<br/><b><font size="2">Ràdio Santa Coloma:</font></b> '+'<font size="2">' + entry['gsx$ràdiosantacoloma'].$t +
									'<br/><b><font size="2">Ràdio Tossa:</font></b> '+'<font size="2">' + entry['gsx$ràdiotossa'].$t +
									'<br/><b><font size="2">Selva FM:</font></b> '+'<font size="2">' + entry['gsx$selvafm'].$t +
									'<br/><b><font size="2">Caldes FM:</font></b> '+'<font size="2">' + entry['gsx$caldesfm'].$t +
									'<br/><b><font size="2">Ràdio Maçanet:</font></b> '+'<font size="2">' + entry['gsx$ràdiomaçanet'].$t +
									'<br/><b><font size="2">Ràdio Breda:</font></b> '+'<font size="2">' + entry['gsx$ràdiobreda'].$t +
									'<br/><b><font size="2">Ràdio Bonmatí:</font></b> '+'<font size="2">' + entry['gsx$ràdiobonmatí'].$t +
									...
									'<br/><b><font size="2">Tot TV:</font></b> '+'<font size="2">' + entry['gsx$tottv'].$t +
