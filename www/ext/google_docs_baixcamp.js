function mmg_google_docs_spreadsheet_baixcamp(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Ona Riudoms:</font></b> '+'<font size="2">' + entry['gsx$onariudoms'].$t +
									'<br/><b><font size="2">Punt 6 Ràdio (Castellvell del Camp):</font></b> '+'<font size="2">' + entry['gsx$punt6ràdiocastellvelldelcamp'].$t +
									'<br/><b><font size="2">Ràdio Alforja:</font></b> '+'<font size="2">' + entry['gsx$ràdioalforja'].$t +
									'<br/><b><font size="2">Ràdio Cambrils:</font></b> '+'<font size="2">' + entry['gsx$ràdiocambrils'].$t +
									'<br/><b><font size="2">Ràdio La Selva:</font></b> '+'<font size="2">' + entry['gsx$ràdiolaselva'].$t +
									'<br/><b><font size="2">Ràdio l&#39;Hospitalet de l&#39;Infant:</font></b> '+'<font size="2">' + entry['gsx$ràdiolhospitaletdelinfant'].$t +
									'<br/><b><font size="2">Ràdio Mont-roig:</font></b> '+'<font size="2">' + entry['gsx$ràdiomont-roig'].$t +
									...
									'<br/><b><font size="2">Canal Reus TV:</font></b> '+'<font size="2">' + entry['gsx$canalreustv'].$t +
