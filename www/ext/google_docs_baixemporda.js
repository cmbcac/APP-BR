function mmg_google_docs_spreadsheet_baixemporda(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">Ràdio Begur:</font></b> '+'<font size="2">' + entry['gsx$ràdiobegur'].$t +
									'<br/><b><font size="2">Ràdio La Bisbal:</font></b> '+'<font size="2">' + entry['gsx$ràdiolabisbal'].$t +
									'<br/><b><font size="2">Ràdio Montgrí:</font></b> '+'<font size="2">' + entry['gsx$ràdiomontgrí'].$t +
									'<br/><b><font size="2">Ràdio Palafrugell:</font></b> '+'<font size="2">' + entry['gsx$ràdiopalafrugell'].$t +
									'<br/><b><font size="2">Ràdio Palamós:</font></b> '+'<font size="2">' + entry['gsx$ràdiopalamós'].$t +
									'<br/><b><font size="2">Ràdio Platja d&#39;Aró:</font></b> '+'<font size="2">' + entry['gsx$ràdioplatjadaro'].$t +
									'<br/><b><font size="2">Ràdio Sant Feliu:</font></b> '+'<font size="2">' + entry['gsx$ràdiosantfeliu'].$t +
									'<br/><b><font size="2">Ràdio Santa Cristina:</font></b> '+'<font size="2">' + entry['gsx$ràdiosantacristina'].$t +
									'<br/><b><font size="2">Ràdio Joy FM:</font></b> '+'<font size="2">' + entry['gsx$joyfm'].$t +
									...
									'<br/><b><font size="2">Televisió Costa Brava:</font></b> '+'<font size="2">' + entry['gsx$televisiócostabrava'].$t +
