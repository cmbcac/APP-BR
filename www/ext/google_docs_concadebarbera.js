function mmg_google_docs_spreadsheet_concadebarbera(id, callback) {
            ...
            var feature = {
                ...
                properties: {
                    ...
                    'description': '<u><b><font size="4">RÀDIO</font></u></b></b>'+
									...
									'<br/><b><font size="2">L&#39;Espluga FM Ràdio:</font></b> '+'<font size="2">' + entry['gsx$lesplugafmràdio'].$t +
									'<br/><b><font size="2">Ràdio Montblanc:</font></b> '+'<font size="2">' + entry['gsx$ràdiomontblanc'].$t +
									'<br/><b><font size="2">Ràdio Santa Coloma de Queralt:</font></b> '+'<font size="2">' + entry['gsx$ràdiosantacolomadequeralt'].$t +
